...
#define HOMING_CYCLE_1 ((1<<Y_AXIS)) // COREXY COMPATIBLE: Then home X
...
#define SPINDLE_MAX_RPM 100 // Max spindle RPM. This value is equal to 100% duty cycle on the PWM.
