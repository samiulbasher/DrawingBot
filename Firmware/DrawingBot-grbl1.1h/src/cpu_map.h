...
#define cpu_map_h
  ...
  #ifdef DRAWINGBOT_SHIELD
    #define X_STEP_BIT      2  // Uno Digital Pin 2
    #define Y_STEP_BIT      3  // Uno Digital Pin 3
    #define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)) // x,y step bits
  #endif
  ...
  #define DIRECTION_PORT    PORTD
    ...
    #define X_DIRECTION_BIT   5  // Uno Digital Pin 5
    #define Y_DIRECTION_BIT   6  // Uno Digital Pin 6
    #define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)) // x,y direction bits
  #endif
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    #define SPINDLE_TCCRA_INIT_MASK      ((1<<WGM20) | (1<<WGM21))  // Configures fast PWM mode. Top 0xFF
