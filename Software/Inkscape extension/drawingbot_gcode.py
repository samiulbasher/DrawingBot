#!/usr/bin/env python 
"""
Modified by samiul 2024', https://github.com/samiulbasher/DrawingBot
...
class laser_gcode(inkex.Effect):
    ...
    def export_gcode(self,gcode):
        ...
        f.write(self.options.servo_up_command + "\n" + self.header + "G1 F" + self.options.x_speed + "\n" + gcode + self.footer)
        f.close()
    ...
    def __init__(self):
        ...
        self.arg_parser.add_argument("--tab",                                   action="store", type=str,               dest="tab",                                 default=True,                          help="The active tab when Apply was pressed")
...
################################################################################
    def effect(self) :
        ...
        self.tools = {
            ...
            "gcode before path": (self.options.servo_down_command + " S" + str(int(self.options.servo_pwn)) + "\nG4 P" + self.options.delay),
            "gcode after path": (self.options.servo_up_command + "\nG4 P" + self.options.delay + "\n" + "G1 F" + self.options.x_speed),
        }
        ...
        # if self.options.tab in ["about", "options"]:
        #     pass
        # else:
        # if self.options.tab == "gcode":    
        #     self.get_info()
        # elif self.options.tab == "setting":
